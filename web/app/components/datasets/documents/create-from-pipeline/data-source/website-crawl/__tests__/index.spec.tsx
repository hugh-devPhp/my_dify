...
vi.mock('../../base/header', () => ({
  default: (props: Record<string, unknown>) => (
    <div data-testid="header">
      <span data-testid="header-doc-title">{props.docTitle as string}</span>
...
vi.mock('../base/crawling', () => ({
  default: (props: Record<string, unknown>) => (
    <div data-testid="crawling">
      <span data-testid="crawling-crawled-num">{props.crawledNum as number}</span>
      <span data-testid="crawling-total-num">{props.totalNum as number}</span>
    </div>
  ),
}))
...
vi.mock('../base/error-message', () => ({
  default: (props: Record<string, unknown>) => (
    <div data-testid="error-message" className={props.className as string}>
      <span data-testid="error-title">{props.title as string}</span>
      <span data-testid="error-msg">{props.errorMsg as string}</span>
    </div>
  ),
}))
